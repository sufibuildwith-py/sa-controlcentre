...
const domains=[{label:'Overview',to:'/'},{label:'People',to:'/people'},{label:'Productions',disabled:true},{label:'Calendar',disabled:true},{label:'Finance',disabled:true}];
const dock=[{label:'Command',to:'/',icon:Home},{label:'Attendance',to:'/attendance',icon:CalendarDays},{label:'Work',icon:CheckSquare,disabled:true},{label:'Communications',icon:MessageCircle,disabled:true},{label:'Search',icon:Search,action:'search'},{label:'Settings',to:'/settings',icon:Settings}];
