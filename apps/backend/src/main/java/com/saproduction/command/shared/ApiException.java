...
public class ApiException extends RuntimeException {
  ...
  public ApiException(HttpStatus status,String code,String message,Map<String,String> fields){super(message);this.status=status;this.code=code;this.fields=fields;}
  public static ApiException conflict(String code,String message,Map<String,String> fields){return new ApiException(HttpStatus.CONFLICT,code,message,fields);}
