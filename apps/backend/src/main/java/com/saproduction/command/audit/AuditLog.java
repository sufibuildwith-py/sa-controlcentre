...
public class AuditLog {
  ...
  @Column(name="actor_id") public String actorId;
  ...
  @JdbcTypeCode(SqlTypes.JSON) @Column(name="before_json", columnDefinition="jsonb") public String beforeJson;
  @JdbcTypeCode(SqlTypes.JSON) @Column(name="after_json", columnDefinition="jsonb") public String afterJson;
