...
@Entity @Table(name="payroll_payments")
public class PayrollPayment {
  public enum Method { CASH,BANK_TRANSFER,UPI,CHEQUE,OTHER }
  ...
  @Enumerated(EnumType.STRING) @Column(name="payment_method",nullable=false) public Method paymentMethod;
