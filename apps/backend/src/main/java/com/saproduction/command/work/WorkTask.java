...
public class WorkTask {
  ...
  @Column(name="production_id") public UUID productionId;
  @Column(name="meeting_origin_id") public UUID meetingOriginId;
  @Column(nullable=false) public String title;public String description;
  @Column(name="assigned_employee_id") public UUID assignedEmployeeId;
  ...
  @PrePersist void create(){var now=Instant.now();createdAt=now;updatedAt=now;if(status==null)status=Status.TODO;if(priority==null)priority=Priority.NORMAL;}
