...
public class LeaveService {
  ...
  private final LeaveRepository requests; private final EmployeeService employees; private final EmployeeRepository employeeRepository; private final AttendanceRepository attendance; private final AuditService audit;
  public LeaveService(LeaveRepository requests,EmployeeService employees,EmployeeRepository employeeRepository,AttendanceRepository attendance,AuditService audit){this.requests=requests;this.employees=employees;this.employeeRepository=employeeRepository;this.attendance=attendance;this.audit=audit;}
