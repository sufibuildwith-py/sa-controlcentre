...
public class CalendarEvent {
  public enum Type { PRODUCTION,SHOOT,MEETING,DEADLINE,INTERNAL,REMINDER }
  ...
  @Column(name="location_name") public String locationName;
  @Column(name="location_address") public String locationAddress;
  @Column(name="production_id") public UUID productionId;
  @Column(name="meeting_id") public UUID meetingId;
