...
public class Production {
  public enum Status { DRAFT,PLANNING,PRE_PRODUCTION,PRODUCTION,POST_PRODUCTION,REVIEW,DELIVERED,CANCELLED }
  public enum Priority { LOW,NORMAL,HIGH,URGENT }
  @Id @GeneratedValue(strategy=GenerationType.UUID) public UUID id;
  @Column(nullable=false) public String title;
  @Column(name="client_name",nullable=false) public String clientName;
  public String description;
  @Column(name="event_date",nullable=false) public LocalDate eventDate;
  ...
  @Column(name="venue_name",nullable=false) public String venueName;
  @Column(name="venue_address") public String venueAddress;
  ...
  @PrePersist void create(){var now=Instant.now();createdAt=now;updatedAt=now;if(status==null)status=Status.DRAFT;if(priority==null)priority=Priority.NORMAL;}
